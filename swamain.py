...
class Wamain_Tool:
    def __init__(self, name):
        self.name = name
        self.twilio_account_sid = "AC9eac86dec2lk00b7c7f7e786e5ac50d"
        self.twilio_auth_token = "51fd45acaa499jd5371140818d2c2"
        self.twilio_number = "+18582392249"

    def firebase_settings(self):
        firebase_config = {
            "apiKey": "AIzaSyD2vMTSufNIHH0Rxkjh8hjoFWPKKMRYiQ",
